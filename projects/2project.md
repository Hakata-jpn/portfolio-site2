...
- Performance issues, basic site operations take too long to complete for dealer customers (ex: An item search takes ~8 seconds, removing an item from a cart takes ~16 with no clear indication that the website is loading.)
...
- Back End restructuring to improve performance **<--- What ended up happening**
